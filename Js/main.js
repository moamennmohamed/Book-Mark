...
var popapSection = document.getElementById("popapSection");
var closePopap = document.getElementById("closePopap");
...
function addWebsite() {
  if (validateForm(siteNameInput) && validateForm(siteUrlInput)) {
    ...
    popapSection.classList.replace("d-none", "d-flex");
  }
}
...
closePopap.addEventListener("click", function () {
  popapSection.classList.replace("d-flex", "d-none");
});
